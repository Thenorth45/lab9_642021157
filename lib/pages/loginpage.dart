      ...
      child: ElevatedButton(
          ...
          onPressed: () async {
            if (_formKey.currentState!.validate()) {
              ...
              var url =
                  Uri.parse('http://642021157.pungpingcoding.online/api/login');
              ...
              if (response.statusCode == 200) {
                ...
                SharedPreferences refer = await prefs;
                await refer.setString("username", jsonStr['user']['name']);
                await refer.setString("userid", jsonStr['user']['id']);
                await refer.setString("token", jsonStr['user']['token']);
              }
