...
import 'package:lab9_642021157/pages/showproductpage.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Future<String?> _authUser(LoginData data) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://642021157.pungpingcoding.online/api/login'),
        body: {
          'email': data.name,
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      // title: 'NorthShop',
      theme: LoginTheme(
        primaryColor: Color.fromARGB(255, 3, 87, 35),
        accentColor: Colors.white,
      ),
      logo: const AssetImage('assets/images/northshop.png'),
      onLogin: _authUser,
